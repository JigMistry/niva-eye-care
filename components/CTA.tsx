...
export default function CTA() {
  ...
  return (
    <section className="bg-gray-50 py-20 lg:py-24" ref={ref}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.7 }}
          className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-cyan-600 via-cyan-700 to-emerald-600 px-6 py-14 text-center shadow-2xl shadow-cyan-900/20 sm:px-12 lg:px-20"
        >
          {/* Decorative circles */}
          <div className="absolute -left-10 -top-10 h-40 w-40 rounded-full bg-white/10 blur-2xl" />
          <div className="absolute -bottom-10 -right-10 h-48 w-48 rounded-full bg-emerald-400/20 blur-2xl" />
