      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" ref={ref}>
        ...
        >
          ...
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Meet <span className="text-secondary">Dr. Minal M. Patel</span>
          </h2>
        ...
        >
          <div className="overflow-hidden rounded-3xl border border-gray-100 bg-linear-to-br from-white to-primary/5 shadow-xl shadow-gray-100/50">
            <div className="grid md:grid-cols-5">
              ...
              <div className="p-6 sm:p-8 md:col-span-3 md:p-10">
                <h4 className="text-xl font-bold text-gray-900">About Dr. Patel</h4>
                ...
                <p className="mt-3 leading-relaxed text-gray-600">
                  ...
                  Patel ensures that every patient receives personalized care and achieves
